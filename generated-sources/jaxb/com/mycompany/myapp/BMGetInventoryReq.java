...
@XmlRootElement(name = "BMGetInventoryReq", namespace = "urn:ebay:api:PayPalAPI")
public class BMGetInventoryReq {

    @XmlElement(name = "BMGetInventoryRequest", namespace = "urn:ebay:api:PayPalAPI", required = true)
