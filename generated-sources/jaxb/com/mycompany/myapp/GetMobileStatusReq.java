...
@XmlRootElement(name = "GetMobileStatusReq", namespace = "urn:ebay:api:PayPalAPI")
public class GetMobileStatusReq {

    @XmlElement(name = "GetMobileStatusRequest", namespace = "urn:ebay:api:PayPalAPI", required = true)
