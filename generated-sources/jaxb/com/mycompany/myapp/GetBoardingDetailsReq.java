...
@XmlRootElement(name = "GetBoardingDetailsReq", namespace = "urn:ebay:api:PayPalAPI")
public class GetBoardingDetailsReq {

    @XmlElement(name = "GetBoardingDetailsRequest", namespace = "urn:ebay:api:PayPalAPI", required = true)
