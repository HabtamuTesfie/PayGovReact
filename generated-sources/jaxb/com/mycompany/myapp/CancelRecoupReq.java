...
@XmlRootElement(name = "CancelRecoupReq", namespace = "urn:ebay:api:PayPalAPI")
public class CancelRecoupReq {

    @XmlElement(name = "CancelRecoupRequest", namespace = "urn:ebay:api:PayPalAPI", required = true)
