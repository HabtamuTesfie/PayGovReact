...
export default class Paygov extends React.Component<any, any> {
    ...
    isValid ():any{
          ...
          if(!this.state.cik || !cikPattern.exec(this.state.cik) || !cccPattern.exec(this.state.ccc)||this.state.ccc.length<6
          || !patternPaymentAmount.exec(this.state.paymentAmount) || !emailPattern.exec(this.state.email) || !phonePattern.exec(this.state.phone) || this.state.phone.length!==10
          )
          {
            return true
          }else{
                  ...
                  <Row className="form">
                    <Col md="3">
                        ...
                        <ValidatedForm onSubmit={this.onSubmit}>
                          ...
                          <Button type="submit" color="primary" id="nxt" tag={Link} to="/pg-confirmation" disabled={this.isValid()}>
                           <span>&nbsp;Next&nbsp;&nbsp;</span>
                          </Button>
