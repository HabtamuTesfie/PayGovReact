...
@XmlRootElement(name = "GetAuthDetailsReq", namespace = "urn:ebay:api:PayPalAPI")
public class GetAuthDetailsReq {

    @XmlElement(name = "GetAuthDetailsRequest", namespace = "urn:ebay:api:PayPalAPI", required = true)
