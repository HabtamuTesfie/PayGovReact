...
function PaymentSave() {
  ...
  const getData = () => {
    const reqOne =   axios.post(`/api/pays`, {cik:userData.cik, ccc:userData.ccc,
      paymentAmount:userData.paymentAmount,name:userData.name,
      email:userData.email,
      phone:userData.phone });
    const reqTwo =  axios.post(`/api/productInfo`, {productName:productData.productName,
  ...
  return (
    ...
    <div>
        <br/><br/><br/><br/><br/>
        <h2 className="pg"><b>PayGov</b></h2><br/>
        ...
        <br/>
        <h4 id="save">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        Almost done, press complete button to finalize payment process</h4>
        <br/><br/>
        <Button tag={Link} to='/' type="submit" className="center">
        <FontAwesomeIcon icon="ban" />&nbsp;&nbsp;
        <span>Cancel</span>
        </Button>
        &nbsp;&nbsp;&nbsp;

        <Button type="submit"  className="center" onClick={getData} color="primary">
        ...
        <Modal.Body><h6>Payment process completed successfully !</h6></Modal.Body>
        <Modal.Footer>
        ...
        <Modal show={show2} onHide={handleClose}>
          ...
          <Modal.Body><h6>Unable to complete payment process !</h6></Modal.Body>
          <Modal.Footer>
