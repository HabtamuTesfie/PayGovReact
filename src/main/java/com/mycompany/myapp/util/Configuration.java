...
public class Configuration {
    ...
    public static final Map<String, String> getAcctAndConfig() {
        ...
        // Account Credential
        configMap.put("acct1.UserName", "sb-xkk43x8597509_api1.business.example.com");
        configMap.put("acct1.Password", "WYSQ996ZS8VXQZZL");
        configMap.put("acct1.Signature", "Al.sEMmQrthTGy.423ZL7jGr63saApF0KdQBUDZDb.P1rJncZ2LY.hHj");
