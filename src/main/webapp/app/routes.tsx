...
import Activemq from './modules/activemq/Activemq';
  ...
  return (
     <div className="view-routes">
         <Switch>
             ...
             <ErrorBoundaryRoute path="/" exact component={ProductInfo} />
             <ErrorBoundaryRoute path="/pgtimer" component={Timer} />
             <ErrorBoundaryRoute path="/Activemq" component={Activemq} />
             <ErrorBoundaryRoute path="/ProductInfo" component={ProductInfo} />
